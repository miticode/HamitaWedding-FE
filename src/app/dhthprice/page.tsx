...
const DHTHPricePage = () => {
  const posters = [
    {
      src: "/images/DHTH1.jpg",
      alt: "Bảng giá gói Đính hôn/Tân hôn (1 ngày)",
    },
    {
      src: "/images/DHTH2.jpg",
      alt: "Bảng giá gói Đính hôn/Tân hôn (1 ngày - có quay phim)",
    },
  ];
